...
class AIUser(
    ...
    def __init__(self, bot):
        ...
        self.cooldown1 = commands.CooldownMapping.from_cooldown(1, 10.0, commands.BucketType.channel)
        self.cooldown2 = commands.CooldownMapping.from_cooldown(2, 30.0, commands.BucketType.channel)
        self.cooldown3 = commands.CooldownMapping.from_cooldown(3, 60.0, commands.BucketType.channel)
